...
<main class="route">
    ...
    <section class="main-content">
            <FlashcardDeck content={flashcardsContent} originalDeck={flashcardsContent} id={slug}  deckName={flashcardDeckName} author={flashcardDeckAuthor} isUsers={userID === flashcardDeckAuthorUID}/>
